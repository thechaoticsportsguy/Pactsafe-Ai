  ...
  return (
    <html lang="en" className={`${inter.variable} ${mono.variable} dark`}>
      ...
      <body className="bg-background text-foreground min-h-screen antialiased">
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-50 focus:inline-flex focus:items-center focus:rounded-lg focus:bg-accent focus:px-4 focus:py-2 focus:text-sm focus:font-medium focus:text-white focus:shadow-glow-accent"
        >
          Skip to content
        </a>
        <ToastProvider>
